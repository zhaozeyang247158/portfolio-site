export default function Footer() {
  return (
    <footer className="mt-20 pb-8 pt-6" style={{ borderTop: '1px dashed rgba(176,168,152,0.4)' }}>
      <div className="page-container flex flex-col md:flex-row items-center justify-between gap-3">
        <div className="flex items-center gap-3">
          <span className="font-mono text-[10px] text-ink-faint tracking-widest">© 2026 赵泽阳</span>
          <span className="text-ink-faint/30 text-xs">·</span>
          <span className="font-mono text-[10px] text-ink-faint tracking-widest">中国农业大学</span>
        </div>
        {/* 手写风格小注 */}
        <span
