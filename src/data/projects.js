    ...
    detail: {
      ...
      contentBlocks: [
        ...
        // 模块 3：12 场景 300 条标准语料库
        {
          ...
          bullets: [
            '初次接触 — 建立第一印象，收集基本情况，判断家长需求类型',
            '效果担忧 — 引导关注学习过程，避免过度承诺提分结果',
            '犹豫观望 — 推动决策节奏，明确不决策的代价',
            '孩子抗拒 — 先处理家长端，不要在孩子未接受时强推',
            '价格敏感 — 价值锚定优先，非价格竞争，明确优惠底线',
            '决策人不一致 — 建议双方到场，避免单方推进后反悔',
            '高一适应 — 强调基础建立期，帮助家长理解学习节奏',
            '高二分化 — 聚焦科目选择和学习方向调整',
            '高三冲刺 — 明确时间紧迫性，推动快速决策',
            '信任不足 — 引导了解机构资质和老师背景，建立基础信任',
            '试听反馈 — 根据试听结果跟进，放大正向体验，消解疑虑',
            '报名后服务 — 明确排课、换课、续课等服务边界，防止口头承诺',
          ],
          images: [],
