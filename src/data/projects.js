...
const projects = [
  ...
  // ── 作品 04：课程顾问销售工作台 ──────────────────────────────
  {
    id: 'course-consultant-sales-workbench',
    title: '课程顾问销售工作台',
    summary: '面向教育课程顾问、销售顾问和教务跟进场景的 AI 销售辅助工作台，通过家长画像识别、标准语料推荐、推荐理由解释和话术改写规划，帮助销售降低话术随意性，提升跟进标准化与新人培训效率。',
    tags: ['AI 产品原型', '教育销售', '课程顾问', '家长画像', '语料推荐', '销售 SOP', 'Claude Code', 'Codex 验收'],
    cover: '/images/course-sales-workbench-cover.png',
    date: '2026',
    detail: {
      background:
        '教育机构的销售跟进往往依赖顾问个人经验，话术随意性高，新人上手慢，沟通中容易出现效果过度承诺、价格随意承诺、退费口径不一致等合规风险。这个项目的出发点是：能否把有经验的销售顾问的跟进逻辑提炼成可复用的标准语料，通过家长画像识别和场景匹配，为销售推荐最合适的话术，并解释为什么推荐这条而不是另一条。项目不是简单的话术库，而是围绕"家长原话 → 家长画像 → 销售场景识别 → Top3 标准语料推荐 → 推荐理由解释 → 下一步动作"的完整销售辅助链路，重点展示 AI 产品设计、业务流程拆解、语料体系建设和 AI 编程工作流能力。',
      approach:
        '开发过程采用 ChatGPT 总控、Claude Code 执行、Codex 验收的三角色协同方式，通过 PRD、ARCHITECTURE、TASKS、ACCEPTANCE、BUG_REPORT 等标准文档形成开发闭环，多轮完成语料生成、语料导入、推荐解释增强和版本冻结。业务逻辑上，我把销售跟进拆成三层：第一层是画像层，根据家长的表达方式识别价格敏感、效果担忧、孩子抗拒等信号；第二层是匹配层，根据画像和场景在 12 类场景 300 条语料中找出最匹配的 Top3；第三层是解释层，展示推荐理由、话术本质和家长心理，让销售知道"为什么推荐这条"而不只是给出一条话术。',
      contentBlocks: [
        // 模块 1：项目整体预览
        {
          type:   'imageText',
          title:  '课程顾问销售辅助工作台：整体定位',
          paragraphs: [
            '这是一个面向教育机构课程顾问的本地销售辅助工具，支持输入家长原话，识别家长心理和当前销售阶段，推荐可复用的标准话术和下一步跟进动作。',
            '当前定位是销售辅助，不是自动代替销售成交。系统推荐的是参考话术，最终表达和节奏判断仍由顾问根据实际沟通情况决定。工具的价值在于：帮助新人快速积累跟进经验，帮助成熟顾问降低临场话术随意性，帮助管理层沉淀标准语料体系。',
            '项目当前版本为 V0.6 Phase1（推荐解释增强已完成），语料库共 312 条内置语料，覆盖 12 类典型销售场景。',
          ],
          bullets: [
            '输入家长原话 → 识别家长画像与销售阶段',
            '匹配 12 场景语料库 → 推荐 Top3 标准话术',
            '展示推荐理由、话术本质、家长心理分析',
            '支持下一步动作建议，形成跟进闭环',
          ],
          images: [
            { src: '/images/course-sales-workbench-cover.png', alt: '工作台首页看板', caption: '真实运行截图：首页看板，展示线索总数、待跟进统计、主要异议分布和近期待跟进线索列表' },
          ],
          tags:  ['项目定位', 'AI 销售辅助', '课程顾问', '教育销售'],
          note:  '',
        },
        // 模块 2：动态家长画像
        {
          type:   'imageText',
          title:  '动态家长画像：先理解家长，再推荐话术',
          paragraphs: [
            '销售跟进中最常见的问题是：没搞清楚家长的真实顾虑，就直接推课。这个模块的核心是先通过家长的表达方式，识别家长当前的心理状态和决策障碍，再决定用什么策略应对。',
            '系统会根据家长的原话，识别以下几类典型信号：价格敏感（频繁询问价格、对比其他机构）、效果担忧（对提分效果持保留态度）、孩子抗拒（孩子本人不配合、不愿上课）、决策人不一致（家长中一方支持一方犹豫）、报名后服务（关注排课、换课、续课等后续服务）等。',
            '识别出画像后，系统不会直接给话术，而是先给出对这类家长的沟通策略建议，帮助销售在推荐话术前先调整沟通方向。',
          ],
          bullets: [
            '价格敏感型：不急于给优惠，先建立价值认知',
            '效果担忧型：不过度承诺，引导关注学习过程和阶段性进展',
            '孩子抗拒型：先聚焦家长端，避免在家长未接受前强推孩子',
            '决策人不一致：建议邀约双方到场，不单独推进',
            '报名后服务型：明确服务边界，避免口头承诺无法兑现',
          ],
          images: [
            { src: '/images/course-sales-workbench-parent-profile.png', alt: '家长画像分析截图', caption: '真实运行截图：输入家长原话后，系统识别出"价格敏感型"，给出真实顾虑、沟通策略和推荐话术' },
          ],
          tags:  ['家长画像', '心理识别', '销售策略', '沟通方向'],
          note:  '// 画像识别是这个项目最难设计的部分，因为实际沟通中家长往往同时有多种顾虑',
        },
        // 模块 3：12 场景 300 条标准语料库
        {
          type:   'imageText',
          title:  '12 类场景、312 条语料：老师式渐进成交语料体系',
          paragraphs: [
            '语料库是这个项目的核心资产。每条语料包括标准话术、电话话术变体、真实案例示例、禁忌表达提示和下一步动作建议，覆盖从初次接触到报名后服务的完整跟进周期。语料风格定位为"老师式渐进成交"——不高压，不强推，以学生学习进展为中心，逐步建立家长信任和意愿。',
          ],
          bullets: [
            '初次接触 / 效果担忧 / 犹豫观望 / 孩子抗拒 / 价格敏感',
            '决策人不一致 / 高一适应 / 高二分化 / 高三冲刺',
            '信任不足 / 试听反馈 / 报名后服务',
          ],
          images: [
            { src: '/images/course-sales-workbench-corpus-library.png', alt: '语料库管理截图', caption: '真实运行截图：语料库管理页，312 条语料按场景、年级、场景难度筛选展示' },
          ],
          tags:  ['语料库', '12 场景', '销售 SOP', '话术标准化'],
          note:  '',
        },
        // 模块 4：Top3 语料推荐与推荐解释
        {
          type:   'imageText',
          title:  'Top3 推荐 + 推荐理由解释：让销售知道为什么',
          paragraphs: [
            '单纯的话术推荐容易变成"黑箱推荐"——系统给了一条话术，但销售不知道为什么是这条、什么时候用、家长听到后的心理反应是什么。这个模块的核心是在推荐话术的同时，展示推荐理由。',
            '每条推荐结果包含四个维度：匹配得分和匹配依据（为什么这条比其他条更适合当前情境）、话术本质（这条话术的底层逻辑是什么，在做什么）、家长心理（家长听到这条话术后可能的心理反应）、下一步动作（这条话术说完之后顾问应该接着做什么）。这套解释结构是 V0.6 Phase1 新增的核心功能，目的是把推荐结果从"给话术"升级为"教思路"。',
          ],
          bullets: [
            '匹配得分与依据：解释为什么这条排第一而不是其他条',
            '话术本质：这条话术的底层销售逻辑（建立信任 / 制造紧迫感 / 消解顾虑等）',
            '家长心理：家长听到后预期的心理反应和行为倾向',
            '下一步动作：当前话术说完后顾问应该立刻跟进的行动',
          ],
          images: [
            { src: '/images/course-sales-workbench-recommend-explain.png', alt: '分析详情与 Top3 推荐截图', caption: '真实运行截图：分析详情页，展示家长状态摘要、成交阻力分析、突破策略和 Top3 语料推荐（含推荐理由解释）' },
          ],
          tags:  ['Top3 推荐', '推荐解释', '可理解性', '话术本质'],
          note:  '// V0.6 Phase1 核心：把推荐从"给话术"升级为"教思路"',
        },
        // 模块 5：AI 编程工作流
        {
          type:   'steps',
          title:  'ChatGPT + Claude Code + Codex：AI 编程协同工作流',
          paragraphs: [
            '整个项目从 V0.1 骨架搭建到 V0.6 Phase1 推荐解释增强，采用 ChatGPT 总控、Claude Code 执行、Codex 验收的三角色协同方式。每个版本有 PRD、TASKS、ACCEPTANCE、BUG_REPORT 等标准文档，改动有 git commit 留痕，验收有 Codex 独立复查。',
          ],
          bullets: [
            'ChatGPT 总控：需求拆解、PRD 起草、任务书生成、返工整理',
            'Claude Code 执行：读取项目文件、修改代码、运行测试、语料生成与批量导入',
            'Codex 验收：基于 ACCEPTANCE 和 git diff 独立检查，输出通过 / 部分通过 / 不通过',
            'V0.1-V0.4：骨架搭建、数据库设计、语料模板与推荐引擎',
            'V0.5：300 条四批语料分批生成并正式导入（corpus_items 共 312 条）',
            'V0.6 Phase1：推荐解释增强完成，tag = v0.6-phase1-recommend-explain',
          ],
          images: [],
          tags:  ['AI 编程工作流', 'ChatGPT 总控', 'Claude Code', 'Codex 验收'],
          note:  '',
        },
        // 模块 6：项目价值与边界
        {
          type:   'imageText',
          title:  '项目价值与边界：这个工具能做什么，不能做什么',
          paragraphs: [
            '这个项目适合用于作品集展示、销售新人培训、小范围辅助试用，展示了"AI + 销售 SOP + 语料库 + 推荐解释"的完整产品化思路。',
            '项目不适合直接用于自动向家长发送话术，也不能替代销售顾问的实际判断。真实业务落地前，仍需接入机构 CRM 系统、价格审批规则、退费政策数据库、排课系统 API、权限审计机制和效果复盘流程。',
            '这个版本的核心价值是：把"有经验的销售怎么判断家长、怎么选择话术"这套隐性知识，用产品化的方式拆解、记录、推荐、解释，让它对新人可理解、对管理层可复盘。',
          ],
          bullets: [
            '适合：销售培训、新人上手、话术标准化沉淀、作品集展示',
            '不适合：自动向家长发送、替代真实销售判断、无合规审查的直接使用',
            '待接入：CRM 系统、价格规则、退费政策、排课系统、权限审计、效果复盘',
            '当前版本价值：把隐性销售经验拆解成可推荐、可解释、可复用的产品形态',
          ],
          images: [
            { src: '/images/course-sales-workbench-followup.png', alt: '线索管理列表截图', caption: '真实运行截图：线索管理页，展示线索列表、意向等级、成交状态和跟进信号汇总' },
          ],
          tags:  ['项目价值', '产品边界', '业务合规', '可落地性'],
          note:  '// 明确边界是这个项目最重要的设计决策之一',
        },
      ],
      highlights: [
        '将教育销售跟进流程拆成家长画像、场景匹配、话术推荐、推荐解释四层可执行产品链路。',
        '构建 12 类场景、312 条标准化语料库，每条语料含话术、案例、禁忌表达和下一步动作。',
        '支持家长画像识别，识别价格敏感、效果担忧、孩子抗拒等典型信号，先理解再推荐。',
        'V0.6 Phase1 引入推荐理由解释（匹配依据、话术本质、家长心理、下一步动作），将"给话术"升级为"教思路"。',
        '明确区分销售辅助与自动成交，保留业务合规边界，不做不切实际的承诺。',
        '使用 ChatGPT 总控、Claude Code 执行、Codex 验收完成规划、开发、语料导入和版本冻结。',
      ],
      conclusion:
        '这个项目让我把对教育销售跟进逻辑的理解落地成了一个可以实际演示的产品原型。从语料体系设计、家长画像分类，到推荐解释框架，每个环节都需要先想清楚"销售在这个场景里真正的判断是什么"，再想怎么用代码和数据结构表达。推荐解释是我在 V0.6 Phase1 里最花时间的部分——不是因为技术复杂，而是因为要把一个有经验销售顾问的直觉拆成可以展示的文字，需要反复推敲每个维度的颗粒度和表达方式。',
    },
  },
